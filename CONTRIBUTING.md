...
LOCAI uses [Weblate](https://hosted.weblate.org/translate/locai) for managing translations. When adding or changing user-facing strings:
...
**To contribute translations**, visit [LOCAI on Weblate](https://hosted.weblate.org/translate/locai) — no code changes needed.
